        ...
        <div className="w-full border border-t border-gray-700 border-opacity-10 mt-2 bg-black">
            <div className="max-w-screen-xl m-auto flex flex-wrap justify-between items-center h-full p-2 overflow-x-auto">
                ...
                <div className="flex flex-col text-gr">
                    <div>
                        <span className="mr-2 whitespace-nowrap" style={{ color: '#e6007a' }}>TIP (DOT):</span><span className="text-gray-400">13Tbq9Exz6r9GzEYxiey6QEQPrnhvecxNv2SPiSMny6CFWqY</span>
                    </div>
                    <div>
                        <span className="mr-2 whitespace-nowrap" style={{ color: '#FF8F00' }}>TIP (KSM):</span><span className="text-gray-400">F2vM8Kmkgbbb73UmnR1rCmFgq5J31szko8hd5ixigHApDNY</span>
                    </div>
                </div>
            </div>
        </div>
